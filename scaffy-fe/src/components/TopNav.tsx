          ...
          <Popover.Trigger asChild>
            ...
            >
              {user.avatarUrl ? (
                ...
                <span
                  aria-hidden="true"
                  className="account-trigger__avatar account-trigger__avatar--fallback"
                >
                  {initial}
                </span>
              )}
  ...
  return (
    <nav aria-label="Primary" className="top-nav">
      <Link aria-label="Scaffy home" className="wordmark" to="/">
        <img alt="" className="wordmark-mark" src="/scaffy-logo.png" /> Scaffy
      </Link>
      ...
      <div className={user ? "nav-actions" : "nav-actions nav-actions--public"}>
        {authContent}
      </div>
      {user ? (
